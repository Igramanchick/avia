...
hairSideR.position.set(8,-7,1);
hairSideL.position.set(8,-7,-12);
hairs.add(hairSideR);
hairs.add(hairSideL);
...
var windsheld = new THREE.Mesh(geomWindshield,matWindshield);
windsheld.position.set(5,27,0);
windsheld.castShadow = true;
windsheld.receiveShadow = true;
this.mesh.add(windsheld)
...
sea.mesh.rotation.z +=.005;
  ...
  airplane.propeller.rotation.x+= 1000
  sea.moveWaves();
  sea.mesh.rotation.z += .005;
  ...
  airplane.mesh.rotation.z = (targetY - airplane.mesh.position.y)*0.0150;
